...
internal constructor(
    ...
    override var name: String
        ...
        set(newName) = parentAsFatDirectory()!!.renameEntry(entry, newName)
    ...
    override fun moveTo(destination: UsbFile) {
        parentAsFatDirectory()!!.move(entry, destination)
        _parent = destination as FatDirectory
    }
